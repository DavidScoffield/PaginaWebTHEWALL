...
<body>
            ...
            <form class="form" id="formulario_logIn">
                <div class="containers contenedor-input">
                    ...
                    <div>
                        ...
                        <input type="text" class="input" name="user" id="login_user" />
                    </div>
                </div>
                <div class="containers contenedor-input">
                    <div class="i">
                    ...
                    <div>
                        ...
                        <input class="input" type="password" name="password" id="login_password" />
                    </div>
                </div>
                <div class="container-dual">
                    <input type="submit" name="btn-submit" id="btn_submitLogIn" value="Enviar" class="btn" />
    ...
    <div class="bg-modal" id="bg-modal-register">
        <div class="window_modal" id="window-modal-register">
            ...
            <form class="form" id="formulario_registro">
                <div class="containers contenedor-input">
                    ...
                    <div>
                        ...
                        <input type="email" class="input" name="email" id="register_email" novalidate />
                    </div>
                </div>
                ...
                <div class="containers contenedor-input">
                    ...
                    <div>
                        ...
                        <input class="input" type="text" name="first-name" id="register_firstName" />
                    </div>
                </div>
                <div class="containers contenedor-input">
                    <div class="i">
                    ...
                    <div>
                        ...
                        <input class="input" type="text" name="last-name" id="register_lastName" />
                    </div>
                </div>
                ...
                <div class="containers contenedor-input">
                    ...
                    <div>
                        ...
                        <input type="text" class="input" name="user" id="register_user" />
                    </div>
                </div>
                ...
                <div class="containers contenedor-input">
                    ...
                    <div>
                        ...
                        <input class="input" type="password" name="password" id="register_password" />
                    </div>
                </div>
                <div class="containers contenedor-input">
                    <div class="i">
                    ...
                    <div>
                        ...
                        <input class="input" type="password" name="repeatPassword" id="register_RepeatPassword" />
                    </div>
                </div>
                ...
                <div class="container-dual">
                    <input type="submit" name="btn-submit" id="btn_submitRegister" value="Enviar" class="btn" />
